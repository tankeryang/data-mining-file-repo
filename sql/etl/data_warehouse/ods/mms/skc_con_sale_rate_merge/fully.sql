DROP TABLE IF EXISTS ods_mms.skc_con_sale_rate_merge;


CREATE TABLE IF NOT EXISTS ods_mms.skc_con_sale_rate_merge (
    store_code           VARCHAR,
    skc_code             VARCHAR,
    repeat_order_amount  INTEGER,
    all_order_amount     INTEGER,
    year_code            VARCHAR,
    week_code            VARCHAR,
    audit_date           VARCHAR
);
