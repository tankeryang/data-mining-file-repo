DROP TABLE IF EXISTS ods_mms.training_data_base_merge;


CREATE TABLE IF NOT EXISTS ods_mms.training_data_base_merge (
    store_code                VARCHAR,
    scc_code                  VARCHAR,
    lcc_code                  VARCHAR,
    ...
    wind_day                  VARCHAR,
    wind_comp_day             TINYINT,
    wind_night                VARCHAR,
    wind_comp_night           TINYINT,
    retail_amount             DECIMAL(30, 2),
    sales_amount              DECIMAL(30, 2),
    discount_rate             DECIMAL(20, 2),
    sales_qty                 INTEGER,
    pos_system                VARCHAR
);
...
INSERT INTO ods_mms.training_data_base_merge
    SELECT
        ...
        cast(sum(mso.quantity) AS INTEGER)                                         sales_qty,
